        ...
        <div class="canvas-container">
          ...
          >
            <el-empty
              ...
              description="拖拽左侧字段到此处开始设计"
            />

            <!-- 字段列表 -->
            <div
              v-else
              class="field-items-list"
            >
              <div
          ...
          <div class="property-panel">
            ...
            >
              ...
              <el-form-item label="栅格跨度">
                <el-slider
                  v-model="selectedField.col.span"
                  :min="1"
                  :max="24"
                  show-stops
              ...
              <el-form-item
                v-if="selectedField.type === 'input'"
                label="最小长度"
              >
                <el-input-number
                  v-model="selectedField.props.minLength"
                  :min="0"
                  placeholder="最小长度"
                />
              </el-form-item>
              ...
              >
                <el-input-number
                  v-model="selectedField.props.maxLength"
                  :min="0"
                  placeholder="最大长度"
                />
              </el-form-item>
...
const fieldRequired = computed({
  ...
  set(val: boolean) {
    ...
    const validates = selectedField.value.validate as import('./types').FormValidateRule[]
