    ...
    <el-card>
      ...
      <el-tabs v-model="activeTab">
        ...
        <el-tab-pane label="Prometheus" name="prometheus">
          <el-form :model="config.prometheus" label-width="140px">
            <el-form-item label="抓取间隔">
              <el-input v-model="config.prometheus.scrapeInterval" placeholder="15s" />
            </el-form-item>

            <el-form-item label="评估间隔">
              <el-input v-model="config.prometheus.evaluationInterval" placeholder="15s" />
            </el-form-item>
            ...
            <el-form-item
              ...
              :label="`Job ${index + 1}`"
            >
              <el-input v-model="scrape.jobName" placeholder="服务名称" style="margin-bottom: 8px" />
              <el-input v-model="scrape.metricsPath" placeholder="/metrics" />
            </el-form-item>

            <el-form-item>
              <el-button @click="addScrapeConfig">添加抓取配置</el-button>
            </el-form-item>
          </el-form>
        </el-tab-pane>
        ...
        <el-tab-pane label="Grafana" name="grafana">
          <el-form :model="config.grafana" label-width="140px">
            <el-form-item label="仪表板标题">
              <el-input v-model="config.grafana.title" placeholder="服务监控" />
            </el-form-item>
            ...
            <el-form-item label="刷新间隔(秒)">
              <el-input-number v-model="config.grafana.refreshInterval" :min="5" :max="300" />
            </el-form-item>
          ...
          <el-form label-width="140px">
            ...
            >
              <el-form-item label="告警名称">
                <el-input v-model="alert.name" placeholder="HighErrorRate" />
              </el-form-item>
              ...
              <el-form-item label="持续时间">
                <el-input v-model="alert.duration" placeholder="5m" />
              </el-form-item>
            ...
            <el-form-item>
              <el-button @click="addAlertRule">添加告警规则</el-button>
            </el-form-item>
          </el-form>
        </el-tab-pane>
      </el-tabs>
      ...
      <div class="action-buttons">
        ...
        <el-button type="success" @click="handleGenerate">生成配置文件</el-button>
      </div>
    </el-card>
  </div>
</template>
