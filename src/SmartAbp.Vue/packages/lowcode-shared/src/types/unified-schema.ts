// @ts-nocheck
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// 🟡 已废弃：统一元数据Schema（Unified Metadata Schema）
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
//
// 废弃日期: 2025-10-18
// 废弃原因: 迁移到后端SSOT（Single Source of Truth）架构
// 替代方案: 使用 @/api/generated/api-client.ts 中的类型
//
// 📋 迁移映射表:
...
//
// 📚 历史背景:
//   本文件曾是前端元数据模型的唯一定义（v1.0.0），包含完整的模块、实体、字段配置。
//   随着架构演进到后端SSOT（Single Source of Truth），为确保前后端类型一致性，
//   已迁移到后端C# DTOs（Application.Contracts层）。
//
//   保留此文件作为历史参考和代码考古，**禁止再次使用**！
//
// 📖 参考文档:
//   - docs/架构设计/低代码引擎v2.0进阶版/Phase1-快速止血方案v1.1-后端SSOT修正版.md
//   - docs/架构设计/低代码引擎v2.0进阶版/Phase3-后端SSOT完整性补强报告.md
//   - docs/架构设计/低代码引擎v2.0进阶版/Phase3-后端SSOT完整性检查.md
//
// ⚠️ 重要警告:
