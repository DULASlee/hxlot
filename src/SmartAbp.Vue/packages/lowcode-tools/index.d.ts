...
export declare const LOWCODE_TOOLS_VERSION = "1.0.0";
export declare const PACKAGE_INFO: {
    readonly name: "@smartabp/lowcode-tools";
    readonly version: "1.0.0";
    readonly description: "SmartAbp LowCode Engine Tools - Bridge Layer between Main App and Packages";
    readonly role: "bridge-layer";
    readonly permissions: readonly ["@/-alias-allowed"];
    readonly author: "SmartAbp Team";
};
