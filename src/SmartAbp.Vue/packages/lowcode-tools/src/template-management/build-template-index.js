  ...
  async processTemplate(filePath) {
    try {
      ...
      const template = {
        ...
        dependencies: validateArray(metadata.dependencies || aiInfo.dependencies || [], 'dependencies'),
  ...
  generateNamingConventions() {
    try {
      return {
        ...
        localization: {
          keys: ["DisplayName:{EntityName}", "Menu:{EntityName}", "Permission:{Action}{EntityName}"]
        }
      }
