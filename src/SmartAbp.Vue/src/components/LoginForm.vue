        ...
        <div class="login-header">
          <div class="company-logo">
            <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
              ...
              <path d="M12 24L18 18L24 24L30 18L36 24" stroke="white" stroke-width="2.5" stroke-linecap="round"/>
          ...
          <div class="form-group">
            ...
            <div class="input-wrapper">
              ...
              <div v-if="loginForm.password && !passwordError" class="password-strength">
                <div class="password-strength-bar" :class="'strength-' + passwordStrength"></div>
              </div>
              <button
                type="button"
