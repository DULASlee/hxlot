...
export function useSecurityDashboard(options = {}) {
    ...
    const openIssuesCount = computed(() => complianceData.value.filter((issue) => issue.status === "Open").length);
    // Mock Data Generation (for testing and development)
    const generateMockSecurityMetrics = () => ({
    ...
    const generateMockAbnormalBehaviors = () => [
        {
            id: "1",
            userId: "user1",
            userName: "John Doe",
