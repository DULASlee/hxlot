    ...
    // 🚀 低代码引擎 - 扁平化二级菜单（避免三层嵌套）
    {
      ...
      children: [
        ...
        },
        {
          ...
          component: "@smartabp/lowcode-designer/src/views/codegen/AspireDesignerView.vue",
          order: 7,
          visible: true,
          requiredRoles: [ROLES.ADMIN, ROLES.USER],
          closable: true,
        ...
        },
        {
          ...
          component: "@smartabp/lowcode-designer/src/views/codegen/ObservabilityDashboard.vue",
          order: 8,
          visible: true,
          requiredRoles: [ROLES.ADMIN, ROLES.USER],
          closable: true,
        ...
        },
        {
          ...
          component: "@smartabp/lowcode-designer/src/views/codegen/ObservabilityConfigPanel.vue",
          order: 9,
          visible: true,
          requiredRoles: [ROLES.ADMIN, ROLES.USER],
          closable: true,
