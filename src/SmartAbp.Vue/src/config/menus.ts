...
// 工具函数：根据key查找菜单项
export const findMenuItemByKey = (key: string, menus: MenuItem[] = menuConfig.menus): MenuItem | null => {
...
// 工具函数：根据路径查找菜单项
export const findMenuItemByPath = (path: string, menus: MenuItem[] = menuConfig.menus): MenuItem | null => {
  for (const menu of menus) {
