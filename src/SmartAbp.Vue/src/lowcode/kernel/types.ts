...
export interface EventBus {
  ...
  emit<K extends keyof LowCodeEventMap>(event: K, data: LowCodeEventMap[K]): Promise<void>
...
export interface CacheStrategy {
  ...
  getEvictionCandidates(entries: Map<string, CacheEntry>, targetSize: number): string[]
}
...
export interface PerformanceMonitor {
  ...
  getAggregatedMetrics(name: string, timeRange: { start: number; end: number }): AggregatedMetrics
