...
export class BasicSchemaReader {
  public readFromVueSFC(_content: string, meta: { moduleName: string; pageName: string }): DesignerOverrideSchema {
...
export function buildOverridesFromState(_state: any, moduleName: string, pageName: string): DesignerOverrideSchema {
