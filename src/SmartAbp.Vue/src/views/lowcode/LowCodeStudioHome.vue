  ...
  <div class="lowcode-studio-home">
    ...
    <div class="welcome-section">
      <div class="welcome-header">
        ...
        <p class="welcome-desc">企业级低代码开发平台，助您快速构建高质量应用</p>
      </div>
    </div>
...
const quickNavItems = ref([
  {
    ...
    title: '实体建模',
    description: '设计数据模型和实体关系',
    icon: DataBoard
  },
  {
    path: '/lowcode/design',
    title: '可视化设计',
    description: '拖拽式页面设计器',
    icon: Brush
  },
  {
    path: '/lowcode/generation',
    title: '代码生成',
    description: '一键生成完整应用代码',
    icon: MagicStick
  },
  {
    path: '/lowcode/theme',
    title: '主题定制',
    description: '自定义应用外观和样式',
    icon: Setting
  }
])
