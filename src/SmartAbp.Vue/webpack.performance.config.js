...
module.exports = {
        ...
        new TerserPlugin({
          terserOptions: {
            compress: {
              ...
              pure_funcs:
                process.env.NODE_ENV === "production" ? ["console.log", "console.info"] : [],
            },
            mangle: {
              safari10: true,
            },
  ...
  monitoring: {
    ...
    // Resource hints
    resourceHints: {
      prefetch: ["advanced-table", "advanced-form", "advanced-chart"],
      preload: ["vue-vendor", "element-plus", "runtime"],
    },
...
const PerformanceAnalyzer = {
  ...
  generateReport: async () => {
    ...
    try {
      ...
      execSync(
        "lighthouse http://localhost:8080 --output=html --output-path=dist/analysis/lighthouse-report.html",
        { stdio: "inherit" },
      )
