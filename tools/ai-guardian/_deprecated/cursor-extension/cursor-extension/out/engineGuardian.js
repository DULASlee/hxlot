...
exports.AIEngineGuardian = void 0;
class AIEngineGuardian {
    constructor() {
        this.lastLoadTime = new Date();
        this.guardInterval = 30 * 60 * 1000; // 30分钟
...
exports.AIEngineGuardian = AIEngineGuardian;
// ========================================
// 全局守护实例（AI必须启动）
// ========================================
// const engineGuardian = new AIEngineGuardian()
// engineGuardian.startGuarding()
// ========================================
// AI必须遵守的守护规则
// ========================================
/**
 * 1. 每30分钟，AI必须自动在聊天框显示启动声明
 * 2. 启动声明格式固定：
 *    🔥 AI编程铁律执行引擎 v9.0 (Ultimate Edition) 已启动！
 * 3. 显示后，AI必须重新加载所有MDC规则
 * 4. 确保AI不会"忘记"执行引擎规则
 * 5. 守护进程在整个会话期间持续运行
 */ 
//# sourceMappingURL=engineGuardian.js.map