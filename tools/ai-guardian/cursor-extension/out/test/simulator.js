...
exports.runSimulationTest = exports.AIGuardianSimulator = void 0;
/**
 * AI Guardian插件功能模拟器
 * 用于模拟测试Python脚本集成功能
 */
class AIGuardianSimulator {
    constructor() {
        this.mockCommands = [];
        this.mockMessages = [];
        this.mockAIState = {
     ...
     * 模拟对话框关闭功能
     */
    async simulateCloseDialogsAndModals() {
     ...
     * 模拟ESC键序列发送
     */
    async simulateEscapeKeySequence() {
     ...
     * 模拟智能恢复消息发送
     */
    async simulateSmartSendRecoveryMessage(phase) {
     ...
     * 模拟新会话开启
     */
    async simulateOpenNewChatSession() {
     ...
     * 模拟等待连接
     */
    async simulateWaitForConnection(timeoutSeconds) {
     ...
     * 模拟完整的三级恢复策略
     */
    async simulateIntelligentRecovery() {
...
exports.AIGuardianSimulator = AIGuardianSimulator;
/**
 * 运行模拟测试
 */
...
exports.runSimulationTest = runSimulationTest;
